...
$reqTournoi = $bdd->prepare("
    SELECT T.nomTournoi, T.dateDebut, T.dateFin, T.description, J.nomJeu
    FROM tournoi T
...
<p><strong>Description :</strong> <?php echo $tournoi['description']; ?></p>
...
<table border="1">
    ...
    <tr>
        ...
        <td><a href="team.php?idTeam=<?php echo $e['idTeam']; ?>">Voir la team</a></td>
    </tr>
    <?php endwhile; ?>
</table>
<?php else: ?>
